    ...
    return (React.createElement("div", { className: Login_module_css_1["default"].cont },
        ...
        React.createElement("div", { className: Login_module_css_1["default"].loginCont },
            React.createElement("div", { className: Login_module_css_1["default"].formDiv },
                ...
                React.createElement("h1", { className: Login_module_css_1["default"].heading }, "Get more things done with Login platform."),
                React.createElement("p", { className: Login_module_css_1["default"].headingp }, "Access to the most powerful tool in the entire design and web industry."),
