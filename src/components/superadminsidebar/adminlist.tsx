...
export default function AdminList() {
  ...
  const filteredAdmins = admins
    ...
    .filter((admin) => {
      ...
      if (statusFilter === "active") return admin.accountStatus === "active";
      if (statusFilter === "inactive") return admin.accountStatus === "inactive";
      if (statusFilter === "N/A") return admin.role !== "admin";
      return true;
    })
    .sort((a, b) => {
      if (sortBy === "name")
