...
function handler(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, userName, email, password, role, existing, newAdmin, err_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    console.log('Received data:', { userName: userName, email: email, password: password, role: role });
                    _b.label = 1;
                case 1:
                    _b.trys.push([1, 5, , 6]);
                ...
                case 4:
                    _b.sent();
                    return [2 /*return*/, res.status(201).json({ message: 'Admin created successfully' })];
                case 5:
                    err_1 = _b.sent();
                    console.error(err_1);
